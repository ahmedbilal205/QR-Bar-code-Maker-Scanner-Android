package anb.developers.com.easyqrmaker.ui.scan;
...
import anb.developers.com.easyqrmaker.helpers.constant.PreferenceKey;
...
import anb.developers.com.easyqrmaker.helpers.util.image.ImageInfo;
import anb.developers.com.easyqrmaker.helpers.util.image.ImagePicker;
import anb.developers.com.easyqrmaker.ui.pickedfromgallery.PickedFromGalleryActivity;
import anb.developers.com.easyqrmaker.ui.scanresult.ScanResultActivity;
        ...
        switch (v.getId()) {
            case R.id.text_view_set_flash:
                ...
                Drawable flashIcon = ContextCompat.getDrawable(mContext,
                        mIsFlashOn ? R.drawable.flash_off_wrapper : R.drawable.flash_on_wrapper);
            ...
            case R.id.text_view_scan_gallery:
                ...
                startActivityForResult(i, ImagePicker.REQUEST_CODE_PICK_IMAGE);
...
//                ImagePicker.pickImage(this);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == ImagePicker.REQUEST_CODE_PICK_IMAGE && mContext != null) {
            Log.d("gallery", "onActivityResult: code is: "+ImagePicker.REQUEST_CODE_PICK_IMAGE);
            ...
            if (result != null) {
                ...
                if (imageInfo != null
                    ...
                    if (!TextUtils.isEmpty(imagePath)) {
                        ...
                        Toast.makeText(mContext, "1 "+getString(R.string.error_did_not_find_any_content),
                                Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(mContext, "2 "+getString(R.string.error_did_not_find_any_content),
                            Toast.LENGTH_SHORT).show();
                }
            }
        }
    ...
    private Result processBitmapToGetResult(Bitmap bitmap) {
        ...
        if (bitmap != null) {
            Bitmap resize = Bitmap.createScaledBitmap(bitmap, bitmap.getWidth()/4,bitmap.getHeight()/4,false);
            ...
            LuminanceSource source =
                    new RGBLuminanceSource(resize.getWidth(), resize.getHeight(), intArray);
            ...
            try {
                ...
                if (!TextUtils.isEmpty(codeResult)) {
                    ...
                    ProgressDialogUtil.on().hideProgressDialog();
                    Toast.makeText(mContext, "3 "+getString(R.string.error_did_not_find_any_content),
                            Toast.LENGTH_SHORT).show();
                ...
                ProgressDialogUtil.on().hideProgressDialog();
                Log.d("gallery", "processBitmapToGetResult: exception : "+e);
                Toast.makeText(mContext,"4 "+ getString(R.string.error_did_not_find_any_content),
                        Toast.LENGTH_SHORT).show();
