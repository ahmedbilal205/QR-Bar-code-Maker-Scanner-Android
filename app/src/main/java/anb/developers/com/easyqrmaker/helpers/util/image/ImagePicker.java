package anb.developers.com.easyqrmaker.helpers.util.image;
...
public class ImagePicker {
    ...
    public synchronized static void pickImage(Fragment fragment) {
        if (fragment != null && fragment.getContext() != null) {
            ...
            Log.d(TAG, "pickImage: here 1 ");
            if (imagePickingIntent != null) {
                Log.d(TAG, "pickImage: here 2");
    ...
    public static Intent getImagePickingIntent(Context context) {
        ...
        if (intentList.size() > 0) {
            Log.d("gallery", "getImagePickingIntent: intent list size "+intentList.size() );
            chooserIntent =
